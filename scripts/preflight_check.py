...
# اتشالت "هو/هي" و"عالم/عالمة" و"معالج/معالجة" من القائمة بعد ست حالات إيجابية كاذبة عبر
# دفعات Task 4.11-4.13: الكلمتين الأخيرتين أسماء عامة ("المعالج" بمعنى المعالِج النفسي كدور
