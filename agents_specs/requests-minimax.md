...
## ✅ 2026-09-02 (الجلسة الرابعة) — اكتشاف وحسم تراكم قائمة سوداء خارج قائمة الأربع قضايا

أثناء التحقق النهائي (preflight + blacklist) بعد إغلاق `ISSUE-RESOLUTION-2026-09-02.md`، اكتُشف تراكم من 528 مخالفة قائمة سوداء حرفية في ملفات موسومة "مكتملة" من جلسات سابقة (branches/relations/concepts). 216 ملف منها (نطاق MiniMax الحصري) أُصلحت بالكامل عبر 8 دفعات متوازية + دفعة استبدال لتقصير أحد الوكلاء. صفر مخالفة متبقية عبر كل نطاق MiniMax (تحقق شخصي مستقل). 667 مخالفة إضافية اكتُشفت في `thinkers/` لكنها كلها ملك مسار Spark (thk-a..l) ولم تُلمس. راجع `agents_specs/reports/minimax/BLACKLIST-SWEEP-2026-09-02.md` للتفصيل الكامل.
...
- `que-mind-body-interaction` (QUE-0015) محجور، ازدواج مع `que-mind-body-interaction-problem` (QUE-0129) الأعمق توثيقاً. القرار المرجّح: `redirect_to: "que-mind-body-interaction-problem"` نهائياً بعد مراجعة بشرية.
...
## من Spark — 2026-09-02 · تناقضان عابران للمسارَين أنشأتهما دفعات Task 6

حذفتُ من ملفَّي عملٍ رقمَي توزيعٍ لم يُسنَدا، فبقي كلٌّ منهما في ملفّ مفكّرٍ **في أرضكم**،
فصار الملفّان متناقضَين. ولا أملك تعديلهما.

| الملفّ عندكم | ما فيه | ما صار في ملفّ العمل |
|---|---|---|
| `content/ar/thinkers/thk-rhonda-byrne.md` | «30 مليون نسخة، 50 لغة» | حُذف من `wrk-the-secret` (دفعة 6.2) |
| `content/ar/thinkers/thk-mitch-albom.md` | «ثمانية عشر مليون نسخة» (وأربع صيغ توزيع في الملف) | حُذف من `wrk-tuesdays-with-morrie` (دفعة 6.4) |

رقم آلبوم يتبع موقع المؤلّف/الناشر («قرابة 18.5 مليون في 51 إقليماً») ولا تدقيق مستقلّاً له.

**والمسألة أوسع من الحالتين:** قِستُ **54 ملفاً** في الشجرة الحيّة تحمل رقم توزيع
(28 في `works/` و26 في `thinkers/`) — التقرير `reports/spark/REVISION/FINDING-distribution-figures.md`.
واقتراحي **قاعدةٌ مشتركة بدل حذفٍ من طرف واحد**: تُنسب الأرقام إلى قائلها
(«يذكر الناشر أنّ…») فتصير واقعةً صادقة عن الناشر بدل واقعةٍ غير قابلة للتحقّق عن الكتاب.
هذا يحلّ الـ54 بقاعدة واحدة ولا يُفقد معلومة ولا يُنشئ تناقضاً. **لم أنفّذ شيئاً في أرضكم.**

وأمرٌ ثالث للعلم: `content/ar/thinkers/thk-mjohnson.md` هو **ماثيو و. جونسون** (باحث
