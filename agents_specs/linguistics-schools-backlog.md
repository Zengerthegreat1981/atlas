...
- [ ] **يتبقّى**: مراجعةُ باقي الـ120 ملف `trm-` بحثاً عن مصطلحاتٍ قابلةٍ للربط
  الصادق (لا اختراع صلة) — أغلبُها مصطلحاتٌ فلسفية/نفسية بلا صلةٍ لسانية حقيقية
  (كـ`trm-akrasia-weakness-of-will`، `trm-aporia-socratic`)، فلا تُقحَم روابطُ
  تعسفية فيها.
