...
## ⚠️ حالةٌ مقيسة (آخر تحديث: 2026-09-22، بعد الدفعة 80)
...
- [ ] **يتبقّى**: مراجعةُ باقي ~117 ملف `trm-` — أغلبُها مصطلحاتٌ فلسفية/نفسية بلا
  صلةٍ لسانية حقيقية (كـ`trm-akrasia-weakness-of-will`)، فلا تُقحَم روابطُ تعسفية فيها.
