...
**قاعدةٌ ملزمة لكل بند**: فحصُ تعارضٍ استباقيّ عبر `find` قبل أيّ كتابة (النمطُ ثبت تكراره أربع مراتٍ في الدورة الأولى)، وربطٌ فوريّ لا استنساخ إن وُجد الشخص/المفهوم تحت قسمٍ آخر.
