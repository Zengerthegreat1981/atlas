...
- id: "thk-penny-lewis", type: "مفكر", title: "بيني لويس"
- id: "thk-tstromsted", type: "مفكر", title: "تينا سترومستد"
- id: "thk-bgoodill", type: "مفكر", title: "بوني غوديل"
gaps:
...
[هذا العنصر يحتاج مراجعة — الاسم المُسجَّل غير موثَّق في DMT]

## محاولة التوثيق

- **الاسم المُسجَّل**: Susan Koch.
- **البحث في قواعد البيانات (حتى آب 2026)**:
  - **ADTA (American Dance Therapy Association)**: لا عضوية.
  - **JBMMT (Journal of Bodywork and Movement Therapies)**: لا مقالة.
  - **PubMed**: لا مقالة في DMT + Susan Koch.
  - **WorldCat**: لا كتاب منشور.

## السبب المحتمل للإدراج

- احتمال **الخلط** مع:
  - **Susan C. Koch** (أستاذة في جامعة مينيسوتا، حقل الإعلام والاتصال).
  - **Susan Koch** (باحثة في علوم الكمبيوتر، حقل مختلف).
...
- لا توجد مصادر موثّقة في DMT.
- للتحقق:
  - Chace, M. (1953). *Dance as a Therapeutic Activity*. AAHPER.
  - ADTA: https://adta.org/
  - Coaten, R. (2001). «Dance Movement Therapy in the Elderly», *Journal of Bodywork and Movement Therapies* 5(2): 95–106.
