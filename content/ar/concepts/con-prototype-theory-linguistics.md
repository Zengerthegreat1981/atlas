...
gaps:
  - "إيلينور روش موسومةٌ `psychology` في الأطلس (`thk-erosch`) بوصفها عالمةَ نفسٍ معرفي أجرت التجارب الأصلية على التصنيف؛ رُبط إليها هنا بـ`related` دون تكرار سيرتها. هذا الملفُّ يوثّق أثرَ نتائجها على الدلالة اللسانية تحديداً لا التجارب النفسية نفسَها."
---
