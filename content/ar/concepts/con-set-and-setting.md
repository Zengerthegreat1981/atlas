...
(1) **Set** (الْإِطَار الذِّهْنِيّ): (أ) «**تَوَقُّع**» (Expectation) — مَاذَا يَتَوَقَّع الْمَرِيض. (ب) «**دَافِع**» (Motivation) — لِمَاذَا هُوَ هُنَا. (ج) «**حَالَة نَفْسِيَّة**» (Mental State) — اكْتِئَاب، قَلَق، صَدْمَة. (د) «**تَارِيخ**» (History) — مَاضِي الْمَرِيض مَع المُسَاعَدَات. (2) **Setting** (الْإِطَار الْبِيئِيّ): (أ) «**غُرْفَة**» (Room) — مُرِيحَة، خَاصَّة، «**لَا مُسْتَشْفَى**» (Hospital). (ب) «**مُعَالِج**» (Therapist) — «**مُؤَهَّل**» (Trained)، «**مُتَعَاطِف**» (Empathic). (ج) «**مُسْتَوَى الرَّاحَة**» (Comfort) — «**أَسِرَّة**» (Beds)، «**وَسَائِد**» (Pillows)، «**غِطَاء**» (Blanket). (د) «**الضَّوْء**» (Light) — خَافِت، مَرِيح.

## الْأَهمِّيَّة

(1) **Set and Setting كَـ**مُتَغَيِّرَات مُسْتَقِلَّة** (Independent Variables): تَحْكَّم فِي «**Set**» وَ**«**Setting**» يُمَكِّن الْبَاحِثِين مِن «**فَصْل**» (Isolate) «**آثَار**» (Effects) الْمَادَّة مِن «**آثَار**» (Effects) الْبِيئَة. (2) **Set and Setting كَـ**تَحْكِيم** (Control): فِي الْعِلَاج، «**Set and Setting**» «**يُسَاعِد**» (Helps) الْمَرِيض عَلَى «**الْاِسْتِرْخَاء**» (Relaxation) وَ**«**الِانْفِتَاح**» (Openness). (3) **Set and Setting كَـ**مُؤَسَّسَة** (Institution): الْعِيَادَات وَالْمَرَاكِز الْمُتَخَصِّصَة فِي الْعِلَاج بِالْمُسَاعَدَة النَّفْسِيَّة تَبْنِي «**Set and Setting**» كَـ**«**مَسَاحَة آمِنَة**» (Safe Space).
